...
class Workout {
  ...
  constructor(coords, distance, duration) {
    ...
    _setDescription(){
      ...
      this._setDescription = `${this.type[0].toUpperCase()}${this.type.slice(1)} on ${months[this.date.getMonth()]} ${this.date.getDate()}`;
...
class App {
  ...
  _loadMap(position) {
    ...
    const arrLoc = [latitude, longitude];

    this.#map = L.map('map').setView(arrLoc, this.#mapZoomLevel);
